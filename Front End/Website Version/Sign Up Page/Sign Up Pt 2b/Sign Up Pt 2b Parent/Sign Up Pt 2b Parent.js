document.addEventListener("DOMContentLoaded", () => {
  ...
  const draftKey = "makerpodsParentAccountDraft";
  ...
  form.addEventListener("submit", (event) => {
    ...
    sessionStorage.setItem("makerpodsUserRole", "parent");
    sessionStorage.setItem("makerpodsParentAccountData", JSON.stringify({ email: email.value.trim(), role: "parent" }));
