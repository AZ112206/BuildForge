document.addEventListener("DOMContentLoaded", () => {
  const form = document.getElementById("student-verify-form");
  ...
  function updateSubmitState() {
    submitBtn.disabled = !codeInputs.every((input) => /^[0-9]$/.test(input.value));
  }
  ...
  codeInputs.forEach((input, index) => {
    ...
    input.addEventListener("paste", (event) => {
      ...
      codeInputs.forEach((box, boxIndex) => { box.value = digits[boxIndex] || ""; });
  ...
  backBtn.addEventListener("click", () => { goTo("../../Sign Up Pt 3/Sign Up Pt 3 Student/Sign Up Pt 3 Student.html"); });
