document.addEventListener("DOMContentLoaded", () => {
  ...
  function applyAppearance() {
    const theme = localStorage.getItem("kidInTheme") || (window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light");
    const mode = localStorage.getItem("kidInSurfaceMode") === "solid" ? "solid" : "transparent";
  ...
  function updateSubmitState() {
    const complete = codeInputs.every((input) => /^[0-9]$/.test(input.value));
