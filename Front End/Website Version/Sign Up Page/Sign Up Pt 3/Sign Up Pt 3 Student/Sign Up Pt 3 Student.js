document.addEventListener("DOMContentLoaded", () => {
  ...
  const draftKey = "kidInStudentAccountDraft";
  ...
  backBtn.addEventListener("click", () => { window.location.href = "../../Sign Up Pt 2/Sign Up Pt 2 Student/Sign Up Pt 2 Student.html"; });
  form.addEventListener("submit", (event) => { event.preventDefault(); sessionStorage.setItem("kidInStudentAccountData", JSON.stringify({ email: email.value.trim(), role: "student" })); });
  updateMeter();
});
